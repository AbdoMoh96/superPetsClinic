<x-admin.dashboard.layout starter="Create Category">
    ...
    <x-slot name="breadcrumbs">
        ...
        <x-admin.dashboard.items.bread-crumb-link active="1" name="create category" />
    </x-slot>
    ...
    <x-slot name="scripts">
        <script src="{{asset('dashboard/js/views/category/create.js')}}"></script>
    </x-slot>
