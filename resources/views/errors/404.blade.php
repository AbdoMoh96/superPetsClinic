...
<div class="error">
    ...
    <div class="error__description">are you lost?</div>
    <a href="{{route('store.index')}}" class="error__button error__button--active" style="margin-top: 10px; display: inline-block; text-decoration: none;">Go Back To Earth</a>
</div>
